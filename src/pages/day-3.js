...
export default function Day3() {
    function solve_part1(){
        ...
        //Keys formatted as "r,c"
        let symbolsMap = findSymbols();
    ...
    function findNumbers(){
        ...
        for(const line of data){
            for(let c = 0; c < line.length; c++){
                // Numbers are 1 to 3 chars long...
                if (!isNaN(parseInt(line[c]))){
                    let len = 1;
                    if (c+1 < line.length && !isNaN(parseInt(line[c+1]))){
                        len = 2;
                        if (c+2 < line.length && !isNaN(parseInt(line[c+2]))){
                            len = 3;
                        }
                    }
                    let valString = '';
                    ...
                    let tempNum = {val:parseInt(valString), points:[]};
                    // Add perimeter points...

                    // Legit for all cases, start upper right and go ccw
                    tempNum.points.push((r-1)+','+(c+1));
                    tempNum.points.push((r-1)+','+c);
                    tempNum.points.push((r-1)+','+(c-1));
                    tempNum.points.push(r+','+(c-1));
                    tempNum.points.push((r+1)+','+(c-1));
                    tempNum.points.push((r+1)+','+c);
                    tempNum.points.push((r+1)+','+(c+1));
                    ...
                    switch (len){
                        case 1:
                            ...
                            break;
                        case 2:
                            tempNum.points.push((r-1)+','+(c+2));
                            tempNum.points.push(r+','+(c+2));
                            tempNum.points.push((r+1)+','+(c+2));
                            break;
                        case 3:
                            tempNum.points.push((r-1)+','+(c+2));
                            tempNum.points.push((r-1)+','+(c+3));
                            tempNum.points.push(r+','+(c+3));
                            tempNum.points.push((r+1)+','+(c+3));
                            tempNum.points.push((r+1)+','+(c+2));
                            break;
                    }
